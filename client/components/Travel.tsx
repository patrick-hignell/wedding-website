  ...
  return (
    <div className="mb-28 flex flex-col items-center">
      ...
      {party.attending == 'Cornwall' ? (
        ...
        <div className="flex w-[60%] flex-col items-center gap-12">
          ...
          <img
            className="max-w-[800px] outline outline-black"
            alt="map"
            src="/images/mapBoth.png"
          />
          <div className=" text-center font-['castoro'] text-4xl tracking-[0.02em]">
